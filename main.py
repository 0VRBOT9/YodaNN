...
def get_args_parser():
    parser = argparse.ArgumentParser('EdgeNeXt training and evaluation script', add_help=False)
    ...
    parser.add_argument('--data_path', default='datasets/cifar10', type=str,
                        help='CIFAR-10 dataset path')
    parser.add_argument('--eval_data_path', default=None, type=str,
                        help='dataset path for evaluation')
    parser.add_argument('--nb_classes', default=10, type=int,  # Update for CIFAR-10
